...
def main():
    ...
    Gender=text_input("GENDER (0=Male, 1=Female)", " ")
    Course=text_input("COURSE (Type a number between 1-121, check list for school names)", " ")
    School_Type=text_input("SCHOOL_TYPE (0=state, 1=Federal , 2=Indigenous , 3=Foreign , 4=Private)", " ")
    Qualification=text_input("QUALIFICATION (0=Masters, 1=HND, 2=PhD, 3=OND, 4=Bachelors)", " ")
    Job_Search_Mode=text_input("JOB_SEARCH MODE (0=UnI/poly, 1=Personal contacts, 2=Employer's website, 3=Media, 4=Recruitment agency-online or offline,5=Social Media, 6=Internship)", " ")
    result=""
